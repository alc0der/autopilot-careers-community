---
rel:source: https://www.linkedin.com/jobs/view/4202829276
tags:
- jd
---
...
- [x] Bachelor's degree in Computer Science, Engineering, or a related technical field, or equivalent practical experience.
- [x] 10+ years of experience in engineering, with at least 3 years in a leadership or managerial role.
- [x] Solid experience across the full engineering stack (front-end, back-end, and AI), with hands-on technical expertise in both.
- [x] Proven experience in code reviews, ensuring adherence to best practices, and helping teams maintain high-quality standards.
...
- [x]  Experience with Agile or Scrum methodologies and leading engineering teams in these frameworks.

**Preferred Qualifications:**

- [x] Master’s degree in Computer Science, AI, Engineering, or a related field.
...
- [x] Familiarity with cloud platforms (AWS, Azure, GCP) and distributed systems.
- [x] Experience in both SaaS and enterprise environments.
- [x] Strong leadership skills with a track record of developing high-performing engineering teams.
