--
rel:source: https://www.linkedin.com/jobs/view/4074012263
tags:
- jd
---
...
We are looking for a strong Principal Backend Engineer. If you are well versed in Microservices, Solution Architecture, including network, data, application, system, and integration architecture - then we are looking for you!
...
- You will mentor them Junior Backend Engineer, and guide from design to deployment.

## Profile Requirements

- 7+ years of intensive Java backend development and solution architecture. (Java, Spring Boot, API Security, Redis, SQL and NoSQL databases, Docker, Kubernetes, AWS)
- 4+ years of experience on Java and should be working on Java 8 or Java 11
...
- Must have working experience on MongoDB and Mysql.
